...
class LossManager():
    def __init__(self, learner):
        ...
        A_ms_m = self.learner.ms_atlas.repeat(learner.batch_size,1,1,1,1)
        self.combo_A = torch.cat([A_m, A_i, A_ms_m], dim=1)
    ...
    def total_loss(self, images, trans_pred, def_field, train = True, record = True):
        ...
        for i in range(len(self.specific_modules)):
            ...
            val = weight*mod.loss_func(self.learner, small_combo_A, trans_pred, def_field)
